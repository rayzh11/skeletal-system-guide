# A Comprehensive Guide to the Human Skeletal System
...
![Bone Composition Illustration](./images/bone_composition.png)
...
![Bone Cells Illustration](./images/bone_cells.png)
...
![Compact vs. Spongy Bone Illustration](./images/compact_vs_spongy_bone.png)
...
Even in adults, the exact number of bones can vary due to anatomical variations, which are completely normal. These can include:
...
![Labeled Human Skeleton](./images/full_skeleton_labeled_front.png)
...
![Skeletal System Functions Infographic](./images/skeletal_system_functions.png)
...
![Tendon vs. Ligament Illustration](./images/tendon_vs_ligament.png)
...
![Endochondral Ossification Stages](./images/endochondral_ossification_stages.png)
...
![Growth Plate Function](./images/growth_plate_function.png)
...
![Joint Anatomy Illustration](./images/joint_anatomy.png)
...
*   **Ball-and-Socket Joints:** These joints allow for the greatest range of motion. The rounded head of one bone fits into a cup-like socket of another. Examples include the shoulder and hip joints.
    ...
    ![Ball-and-Socket Joint Examples](./images/ball_socket_joint_examples.png)
...
*   **Hinge Joints:** These joints allow for movement in only one direction, like the hinge of a door. Examples include the elbow, knee, and finger joints.
    ...
    ![Hinge Joint Examples](./images/hinge_joint_examples.png)
...
![Major Bones of the Skeleton](./images/skeleton_major_bones_labeled.png)

### The Skull

![Labeled Skull Bones](./images/skull_bones_labeled.png)

### The Hand

![Labeled Hand Bones](./images/hand_bones_labeled.png)

### The Foot

![Labeled Foot Bones](./images/foot_bones_labeled.png)

### The Spine

![Labeled Spine Vertebrae](./images/spine_vertebrae_labeled.png)
...
![Bone Fracture Types](./images/bone_fracture_types.png)

Fractures heal in three main stages: the inflammatory stage, the reparative stage, and the remodeling stage.

![Fracture Healing Stages](./images/fracture_healing_stages.png)
...
*   **A sprain** is a stretching or tearing of a **ligament** (which connects bone to bone).
    ...
    ![Sprain Ligament Injury](./images/sprain_ligament_injury.png)

*   **A strain** is a stretching or tearing of a **muscle or tendon** (which connects muscle to bone).

    ![Strain Muscle/Tendon Injury](./images/strain_muscle_tendon_injury.png)
...
![Osteoarthritis vs. Rheumatoid Arthritis](./images/osteoarthritis_vs_rheumatoid.png)
...
![Osteoporosis Bone Comparison](./images/osteoporosis_bone_comparison.png)
